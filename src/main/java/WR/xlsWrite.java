...
public class xlsWrite {
    ...
    public static void writeXlsStatistics(List<Statistic> statisticsList,
        ...
        for (Statistic statistics : statisticsList) {
            ...
            numberOfStudentsCell.setCellValue(statistics.getNumberOfStud());
            Cell numberOfUniversitiesCell = dataRow.createCell(3);
            numberOfUniversitiesCell.setCellValue(statistics.getNumberOfUni());
